    ...
    public class RolesController : Controller
        {
            ...
            public RolesController(RoleManager<IdentityRole> roleManager, UserManager<WebViewerUser> userManager)
            {
            ...
            WebViewerUser user = await _userManager.FindByIdAsync(userId);
                if (user != null)
                {
